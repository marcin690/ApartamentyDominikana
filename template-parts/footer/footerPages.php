                    ...
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            <div class="about-logo">
                                <a href="<?php echo home_url(); ?>"><img src="<?php echo the_field('logo_white', 'option'); ?>" alt="<?php echo get_bloginfo('name'); ?>"></a>
                            </div>
                            <p class="about-text">
                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="th-widget-contact">
                            <div class="info-box_text">
                                ...
                                <div class="details">
                                    <h6 class="about-contact-details-title text-white   ">Kontakt w Dominikanie </h6>
                            ...
                            <div class="info-box_text pt-4">
                                ...
                                <div class="details">
                                    <h6 class="about-contact-details-title text-white">Kontakt w Polsce</h6>
            ...
            <div class="row gy-2 align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <div class="footer-links">
                        <ul>
                            <li><a class="text-dark" href="<?php echo home_url(); ?>/polityka-prywatnosci/">Polityka prywatności</a></li>
